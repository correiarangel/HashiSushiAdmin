...
public class AdapterItensPedido extends
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        holder.idProd.setText("Cod Produto :"+itens.getIdProduct());
        holder.nameProduction.setText("Nome Produto:"+itens.getNameProduct());
        holder.sales_price.setText("R$ :"+itens.getItenSalePrice());
        holder.quantity.setText("Qt:"+ itens.getQuantity());
